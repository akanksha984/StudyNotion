        ...
        <div className="min-h-[calc(100vh-3.5rem)] grid place-items-center">
            {
                ...
                :(
                    <div className="max-w-[500px] p-4 lg:p-8">
                        ...
                        <p className="text-richblack-100 text-[1.125rem] leading-[1.625rem] my-4">A verification code has been sent to your email address. Please enter the code below:</p>
                        <form onSubmit={submitHandler}>
                            <OTPInput
                                ...
                                renderInput={(props)=><input {...props} placeholder="0" style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)"}}
