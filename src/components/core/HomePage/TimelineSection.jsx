...
const timeline= [
    {
        Logo: Logo1,
        heading: "Leadership",
        Desscription: "Fully committed to the success company"
    },
    {
        Logo: Logo2,
        heading: "Responsibility",
        Desscription: "Students will always be our top priority"
    },
    {
        Logo: Logo3,
        heading: "Flexibility",
        Desscription: "The ability to switch is an important skill"
    },
    {
        Logo: Logo4,
        heading: "Solve the problem",
        Desscription: "Code your way to a solution"
    }
]
                            ...
                            return (
                                <div className="flex flex-row gap-6" key={index}>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base">{element.Desscription}</p>
                                    </div>
                                </div>
                            )
                        })
